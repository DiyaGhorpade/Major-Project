...
Property 3: For any length-8 fields list where exactly one of soil (idx 4),
temperature (idx 5), humidity (idx 6), or light (idx 7) contains a string that
...
# Base valid 8-field list — all fields parseable and in-range
VALID_BASE = ["2024-01-01T10:00:00", "1", "1", "1", "50.0", "20.0", "50.0", "500.0"]

# Float sensor fields: (name, index)
FLOAT_FIELDS = [("soil", 4), ("temperature", 5), ("humidity", 6), ("light", 7)]
